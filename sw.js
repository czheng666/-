const CACHE_NAME = "clinical-capture-v60";
const APP_SHELL = ["./", "./index.html", "./styles.css?v=30", "./app.js?v=ocr-mixed-batch-v5", "./manifest.webmanifest", "./vendor/sheetjs/xlsx.full.min.js"];
