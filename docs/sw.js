const CACHE_NAME = "clinical-capture-v61";
const APP_SHELL = ["./", "./index.html", "./styles.css?v=30", "./app.js?v=ocr-research-rules-v6", "./manifest.webmanifest", "./vendor/sheetjs/xlsx.full.min.js"];
