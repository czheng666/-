const CACHE_NAME = "clinical-capture-v54";
const APP_SHELL = ["./", "./index.html", "./styles.css?v=30", "./app.js?v=ocr-photo-v2", "./manifest.webmanifest", "./vendor/sheetjs/xlsx.full.min.js"];
