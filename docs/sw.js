const CACHE_NAME = "clinical-capture-v57";
const APP_SHELL = ["./", "./index.html", "./styles.css?v=30", "./app.js?v=ocr-local-v2", "./manifest.webmanifest", "./vendor/sheetjs/xlsx.full.min.js"];
